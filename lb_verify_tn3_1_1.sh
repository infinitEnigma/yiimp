...
echo "Lucky Blocks from block 100020 to 120023"
set -v
./raptoreum-cli validateaddress "RD1iSNbCb5vLpSGRWHp3S2fpZvktfvbxMK" | grep ismine
./raptoreum-cli validateaddress "RA6bZihofjJZdW6bWWgoecmuaY5wsMCSen" | grep ismine
./raptoreum-cli validateaddress "RREbbxNRvxGw67hNcSADGPR3WTvdAdjtng" | grep ismine
./raptoreum-cli validateaddress "RGxPrCuiHR6YAX2xAmXnGYBzucRHpps5ck" | grep ismine
./raptoreum-cli validateaddress "RAp75Q7zXDyScqc7bZ1geWwvivC8wGCFrD" | grep ismine
./raptoreum-cli validateaddress "R9k11cqGQUWMg2Cd43UeNx95jDM5VvC42Q" | grep ismine
./raptoreum-cli validateaddress "RS4eXQiSqdgnjF3fswSv295yXUgEJVYypp" | grep ismine
./raptoreum-cli validateaddress "RLm8ENkFRBnq71tm3f89VxHVdTbAEhGf6T" | grep ismine
./raptoreum-cli validateaddress "RYcLfaHdY2NBwCr6yiWWKdJjG5R9RZRrDb" | grep ismine
./raptoreum-cli validateaddress "RTEkgXK5Bav71cppcdR24j9jFJDWkjA2bm" | grep ismine
set +v
echo
...
echo "Regular Blocks from block 100020 to 120023"
set -v
./raptoreum-cli validateaddress "RA6bZihofjJZdW6bWWgoecmuaY5wsMCSen" | grep ismine
