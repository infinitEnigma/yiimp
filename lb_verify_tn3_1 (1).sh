...
echo "Lucky Blocks from block 80016 to 100019"
set -v
...
echo "Regular Blocks from block 80016 to 100019"
set -v
...
./raptoreum-cli validateaddress "RWd1uv1agLnmLrvt1boo1k1aNFoVUCc15u" | grep ismine
